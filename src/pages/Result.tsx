...
import { Anchor, Breadcrumbs, Button, Container, Grid, Modal, Space, useMantineTheme } from '@mantine/core';
        ...
        <main className="bg-light">
                ...
                <Grid gutter={10} className="mt-16">
                    {flights.map((flight: any, index: any) => (
                        <Grid.Col key={index} md={6} lg={4}>
                            <FlightCard key={index} data={flight} setOpened={()=>setOpened(true)} />
                        </Grid.Col>
                    ))}
                </Grid>
            ...
            >
                {flight.map((flightData: any, index: number) => (
                    <FlightListItem data={flightData} changeFligth={index <= 0} />
                ))}
            </Modal>
        </main>
    )
